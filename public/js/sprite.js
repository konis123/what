...
var Sprite = function(fn) {
    ...
    this.draw = function(x, y, various)
    {
        ...
        {
            if (AnimationCounter[AnimationCounterIndex].animationDelay++ >= 2) {
            ...
            var res = i2xy(AnimationCounter[AnimationCounterIndex].animationCurrentFrame, 12);
            Context.context.drawImage(this.image, res[0]*32, res[1]*32, 32, 32, x, y, 32, 32);
